...
sequenceDiagram
    ...
    Note over Test: test_ast_can_be_created
    Test->>SUT: AST("root")
    SUT-->>Test: ast
    Test->>Test: assert ast.root_node == "root"

    Note over Test: test_traverse
    Test->>SUT: AST("root")
    SUT-->>Test: ast
...
sequenceDiagram
    ...
    Note over Test: test_create_logical_plan
    ...
    Note over Test: test_create_physical_plan
    ...
    Note over Test: test_plan_table_scan
    ...
    Note over Test: test_plan_index_scan
    ...
    Note over Test: test_plan_aggregation
    ...
    Note over Test: test_reject_invalid_plan
    Test->>SUT: create_logical_plan(invalid_ast)
    activate SUT
    SUT-->>Test: raises InvalidPlanError
    deactivate SUT

    Note over Test: test_execution_planner_can_be_created
...
sequenceDiagram
    ...
    Note over Test: test_tokenize_keyword
    Test->>SUT: Lexer("SELECT")
    SUT-->>Test: lexer
    Test->>SUT: tokenize()
    SUT-->>Test: [Token(SELECT)]

    Note over Test: test_tokenize_identifier
    Test->>SUT: Lexer("users")
    SUT-->>Test: lexer
    Test->>SUT: tokenize()
    SUT-->>Test: [Token(IDENTIFIER, "users")]

    Note over Test: test_tokenize_literal
    Test->>SUT: Lexer("123")
    SUT-->>Test: lexer
    Test->>SUT: tokenize()
    SUT-->>Test: [Token(LITERAL_INT, "123")]

    Note over Test: test_tokenize_operator
    Test->>SUT: Lexer("=")
    SUT-->>Test: lexer
    Test->>SUT: tokenize()
    SUT-->>Test: [Token(EQUALS)]

    Note over Test: test_track_token_position
    Test->>SUT: Lexer("SELECT")
    SUT-->>Test: lexer
    Test->>SUT: tokenize()
    SUT-->>Test: [Token(SELECT, position=0)]

    Note over Test: test_ignore_whitespace
    Test->>SUT: Lexer("  SELECT  ")
    SUT-->>Test: lexer
    Test->>SUT: tokenize()
    SUT-->>Test: [Token(SELECT)]

    Note over Test: test_reject_unknown_character
    Test->>SUT: Lexer("@")
    SUT-->>Test: lexer
    Test->>SUT: tokenize()
    activate SUT
    ...
    Note over Test: test_lexer_can_be_created
    Test->>SUT: Lexer()
    SUT-->>Test: lexer
...
sequenceDiagram
    ...
    Note over Test: test_execute_query_plan
    ...
    Note over Test: test_execute_select
    Test->>SUT: execute_select(Plan)
    SUT-->>Test: rows

    Note over Test: test_execute_insert
    Test->>SUT: execute_insert(Plan)
    SUT-->>Test: affected_rows

    Note over Test: test_execute_update
    Test->>SUT: execute_update(Plan)
    SUT-->>Test: affected_rows

    Note over Test: test_execute_delete
    Test->>SUT: execute_delete(Plan)
    SUT-->>Test: affected_rows

    Note over Test: test_execute_filter
    Test->>SUT: execute_filter(Plan)
    SUT-->>Test: rows

    Note over Test: test_execute_join
    Test->>SUT: execute_join(Plan)
    SUT-->>Test: rows

    Note over Test: test_execute_aggregation
    Test->>SUT: execute_aggregation(Plan)
    SUT-->>Test: rows

    Note over Test: test_return_empty_result
    Test->>SUT: execute_select(empty_Plan)
    SUT-->>Test: []

    Note over Test: test_rollback_on_failure
    ...
    Note over Test: test_query_executor_can_be_created
...
sequenceDiagram
    ...
    Note over Test: test_estimate_cost
    ...
    Note over Test: test_select_lowest_cost_plan
    ...
    Note over Test: test_reorder_join
    ...
    Note over Test: test_select_index
    Test->>SUT: optimize(LP)
    activate SUT
    ...
    Note over Test: test_push_predicate
    Test->>SUT: optimize(LP)
    activate SUT
    ...
    Note over Test: test_use_safe_estimate_without_statistics
    Test->>SUT: estimate_cost(LP)
    activate SUT
    ...
    Note over Test: test_preserve_query_result
    Test->>SUT: optimize(LP)
    activate SUT
    ...
    Note over Test: test_query_optimizer_can_be_created
...
sequenceDiagram
    ...
    Note over Test: test_query_processor_can_be_created
    Test->>SUT: QueryProcessor(Parser, Validator, Executor)
    SUT-->>Test: qp
    Test->>Test: assert isinstance(qp, QueryProcessor)

    Note over Test: test_query_processor_stores_dependencies
    Test->>SUT: QueryProcessor(Parser, Validator, Executor)
    SUT-->>Test: qp
...
sequenceDiagram
    ...
    Note over Test: test_validate_table
    ...
    Note over Test: test_validate_column
    ...
    Note over Test: test_validate_data_type
    ...
    Note over Test: test_validate_permission
    ...
    Note over Test: test_reject_unknown_table
    ...
    Note over Test: test_reject_unknown_column
...
sequenceDiagram
    ...
    Note over Test: test_select_statement_stores_basic_select_attributes
...
sequenceDiagram
    ...
    Note over Test: test_statement_stores_statement_type
...
sequenceDiagram
    ...
    Note over Test: test_token_stores_type_value_and_position
...
sequenceDiagram
    ...
    Note over Test: test_token_type_defines_categories
